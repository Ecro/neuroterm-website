    ...
    <div className="min-h-screen pt-24 pb-16">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="flex items-center gap-2 text-sm text-white/40 mb-8">
          ...
          <span>/</span>
          <span className="text-white/60">Serial Port</span>
        </div>
        ...
        <section className="mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="p-5 rounded-xl border border-white/5 bg-white/[0.02]">
              ...
              <div className="p-3 rounded-lg bg-white/5 font-mono text-sm">
                <span className="text-white/40">Windows:</span> <span className="text-white">COM1, COM3, COM4...</span>
              </div>
            </div>
            ...
            <div className="p-5 rounded-xl border border-white/5 bg-white/[0.02]">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  <div className="text-white/40 text-xs uppercase tracking-wide mb-2">Data Bits</div>
                  <div className="flex gap-2">
                    {['5', '6', '7', '8'].map((bits) => (
                      <span
                        key={bits}
                        className={`px-3 py-1.5 rounded text-sm font-mono ${
                          bits === '8' ? 'bg-white/10 text-white' : 'bg-white/5 text-white/40'
                        }`}
                      >
                        {bits}
                      </span>
                ...
                <div>
                  <div className="text-white/40 text-xs uppercase tracking-wide mb-2">Parity</div>
                  <div className="flex gap-2">
                    {['None', 'Odd', 'Even'].map((p) => (
                      <span
                        key={p}
                        className={`px-3 py-1.5 rounded text-sm ${
                          p === 'None' ? 'bg-white/10 text-white' : 'bg-white/5 text-white/40'
                        }`}
                      >
                        {p}
                      </span>
                ...
                <div>
                  <div className="text-white/40 text-xs uppercase tracking-wide mb-2">Stop Bits</div>
                  <div className="flex gap-2">
                    {['1', '1.5', '2'].map((bits) => (
                      <span
                        key={bits}
                        className={`px-3 py-1.5 rounded text-sm font-mono ${
                          bits === '1' ? 'bg-white/10 text-white' : 'bg-white/5 text-white/40'
                        }`}
                      >
                        {bits}
                      </span>
        ...
        <section className="mb-12">
          ...
          <div className="p-5 rounded-xl border border-white/5 bg-white/[0.02] mb-4">
