    ...
    <div className="min-h-screen pt-24 pb-16">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="flex items-center gap-2 text-sm text-zinc-500 mb-8">
          ...
          <span>/</span>
          <span className="text-zinc-400">Local RAG</span>
        </div>
          ...
          <div className="rounded-xl border border-white/10 bg-[#0d1117] overflow-hidden">
            <div className="p-4 font-mono text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-zinc-200">&quot;what&apos;s the GPIO pin for the status LED?&quot;</span>
              </div>
              <div className="mt-3 p-3 rounded-lg bg-zinc-800 border border-emerald-500/20">
          ...
          <div className="space-y-4 mb-6">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-zinc-400 text-sm">Click the gear icon or press Ctrl+,</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="step-badge flex-shrink-0">
              ...
              <div>
                ...
                <p className="text-zinc-400 text-sm">Find &quot;Knowledge Base&quot; in settings</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="step-badge flex-shrink-0">
              ...
              <div>
                ...
                <p className="text-zinc-400 text-sm">Click &quot;Import&quot; and select your files</p>
              </div>
            </div>
          </div>

          <div className="p-5 rounded-xl border border-white/10 bg-zinc-900/70">
            <h3 className="text-white font-medium mb-3">Supported Formats</h3>
            <div className="flex flex-wrap gap-2">
              <span className="px-3 py-1.5 rounded-lg text-sm font-mono bg-zinc-800 text-zinc-400">.txt</span>
              <span className="px-3 py-1.5 rounded-lg text-sm font-mono bg-zinc-800 text-zinc-400">.md</span>
              <span className="px-3 py-1.5 rounded-lg text-sm font-mono bg-zinc-800 text-zinc-400">.markdown</span>
            </div>
        ...
        <section className="mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 rounded-lg border border-white/10 bg-zinc-900/70">
              ...
              <p className="text-zinc-400 text-sm">
                Name files descriptively: <code className="text-cyan-300">imx8mp-gpio-pinmux.md</code> instead of <code className="text-zinc-400">notes.txt</code>
              </p>
            </div>
