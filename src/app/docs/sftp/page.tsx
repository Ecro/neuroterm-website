    ...
    <div className="min-h-screen pt-24 pb-16">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="flex items-center gap-2 text-sm text-zinc-500 mb-8">
          ...
          <span>/</span>
          <span className="text-zinc-400">SFTP</span>
        </div>
        ...
        <section className="mb-12">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3 p-4 rounded-lg border border-white/10 bg-zinc-900/70">
          ...
          <div className="p-5 rounded-xl border border-white/10 bg-zinc-900/70">
            <div className="grid gap-3 text-sm">
              ...
              <div className="flex items-center justify-between py-2">
                ...
                <span className="text-zinc-400">Not supported (restart required)</span>
              </div>
            </div>
          </div>
        </section>
