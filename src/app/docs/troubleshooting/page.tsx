    ...
    <div className="min-h-screen pt-24 pb-16">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="flex items-center gap-2 text-sm text-zinc-500 mb-8">
          ...
          <span>/</span>
          <span className="text-zinc-400">Troubleshooting</span>
        </div>
          ...
          <div className="p-5 rounded-xl bg-gradient-to-br from-cyan-500/10 to-emerald-500/10 border border-cyan-500/20">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <Link
                  href="/support"
                  className="inline-flex items-center gap-2 px-4 py-2 bg-zinc-800 text-white text-sm font-medium rounded-lg hover:bg-white/20 transition-colors"
                >
                  Get Support
