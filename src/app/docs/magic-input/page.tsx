    ...
    <div className="min-h-screen pt-24 pb-16">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="flex items-center gap-2 text-sm text-zinc-500 mb-8">
          ...
          <span>/</span>
          <span className="text-zinc-400">Magic Input</span>
        </div>
          ...
          <div className="space-y-4 mb-6">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-zinc-400 text-sm">Opens the Magic Input prompt</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="step-badge flex-shrink-0">
              ...
              <div>
                ...
                <p className="text-zinc-400 text-sm">&quot;show all running processes&quot;</p>
              </div>
            </div>
            <div className="flex gap-4">
              <div className="step-badge flex-shrink-0">
              ...
              <div>
                ...
                <p className="text-zinc-400 text-sm">Press Enter to insert, Tab to copy, Esc to cancel</p>
              </div>
            </div>
          </div>

          <div className="rounded-xl border border-white/10 bg-[#0d1117] overflow-hidden">
            <div className="flex items-center gap-2 px-4 py-2 border-b border-white/10 bg-zinc-900/70">
            ...
            <div className="p-4 font-mono text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-zinc-200">&quot;find large files over 100MB&quot;</span>
              </div>
        ...
        <section className="mb-12">
          ...
          <div className="rounded-xl border border-white/10 bg-zinc-900/70 overflow-hidden">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-white/10">
                  <th className="text-left p-4 text-zinc-400 font-normal">Key</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="p-4 text-zinc-300">Cancel and close</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section className="mb-12">
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={example.prompt} className="flex items-center gap-4 p-3 rounded-lg border border-white/10 bg-zinc-900/70">
                <div className="flex-1">
                  <span className="text-cyan-400">@</span>
                  <span className="text-zinc-300 ml-1">&quot;{example.prompt}&quot;</span>
                </div>
        ...
        <section className="mb-12">
          ...
          <div className="rounded-xl border border-white/10 bg-[#0d1117] overflow-hidden mb-4">
            <div className="p-4 font-mono text-sm">
              <div className="flex items-center gap-2">
                <span className="text-cyan-400">@</span>
                <span className="text-zinc-200">&quot;turn on the status LED&quot;</span>
              </div>
              <div className="mt-3 p-3 rounded-lg bg-white/5 border border-emerald-500/20">
                <div className="text-emerald-400 text-xs mb-2 flex items-center gap-1.5">
                  <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <section className="mb-12">
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-lg border border-white/10 bg-zinc-900/70">
        ...
        <section className="mb-12">
          ...
          <div className="grid gap-4">
            <Link
              href="/docs/local-rag"
              className="flex items-center justify-between p-4 rounded-xl border border-white/10 bg-zinc-900/70 hover:bg-zinc-800/90 transition-colors group"
            >
              <div>
                <div className="font-medium text-white group-hover:text-emerald-300 transition-colors">
                  Local RAG
                </div>
                <div className="text-zinc-500 text-sm">Import datasheets for context-aware commands</div>
              </div>
            ...
            >
              <div>
                ...
                <div className="text-zinc-500 text-sm">Configure the AI model powering Magic Input</div>
              </div>
              <svg className="w-5 h-5 text-zinc-600 group-hover:text-zinc-400 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
              </svg>
