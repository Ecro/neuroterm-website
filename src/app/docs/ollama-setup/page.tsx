    ...
    <div className="min-h-screen pt-24 pb-16">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="flex items-center gap-2 text-sm text-white/40 mb-8">
          ...
          <span>/</span>
          <span className="text-white/60">Ollama Setup</span>
        </div>
        ...
        <section className="mb-12">
          ...
          <div className="rounded-lg bg-[#0d1117] border border-white/10 overflow-hidden mb-4">
            <div className="flex items-center justify-between px-4 py-2 border-b border-white/5 bg-white/[0.02]">
              <span className="text-white/40 text-xs font-mono">Terminal</span>
            </div>
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-lg border border-white/5 bg-white/[0.02]">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-white/40 text-xs uppercase tracking-wide mb-1">Ollama Endpoint</div>
            ...
            <div className="p-4 rounded-lg border border-white/5 bg-white/[0.02]">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-white/40 text-xs uppercase tracking-wide mb-1">Model</div>
                  <code className="text-white font-mono">llama3.2</code>
                </div>
                <span className="text-white/40 text-xs">Your pulled model</span>
              </div>
            </div>
          </div>
        ...
        <section className="mb-12">
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-lg border border-white/5 bg-white/[0.02]">
              ...
              <p className="text-white/50 text-sm">
                Make sure Ollama is running. Check your system tray for the llama icon, or run <code className="px-1.5 py-0.5 rounded bg-white/10 text-white/80 font-mono text-xs">ollama serve</code> manually.
              </p>
            </div>
            ...
            <div className="p-4 rounded-lg border border-white/5 bg-white/[0.02]">
              ...
              <p className="text-white/50 text-sm">
                Try a smaller model like <code className="px-1.5 py-0.5 rounded bg-white/10 text-white/80 font-mono text-xs">qwen2.5:1.5b</code>. If you have an NVIDIA GPU, Ollama will use it automatically for faster inference.
              </p>
            </div>
            ...
            <div className="p-4 rounded-lg border border-white/5 bg-white/[0.02]">
              ...
              <p className="text-white/50 text-sm">
                Ensure the model name in NeuroTerm settings matches exactly what you pulled. Run <code className="px-1.5 py-0.5 rounded bg-white/10 text-white/80 font-mono text-xs">ollama list</code> to see available models.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="grid gap-4">
            ...
            >
              <div>
                ...
                <div className="text-white/40 text-sm">Connect to your first device</div>
              </div>
            ...
            >
              <div>
                ...
                <div className="text-white/40 text-sm">Learn to use AI-powered commands</div>
              </div>
              <svg className="w-5 h-5 text-white/20 group-hover:text-white/40 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
              </svg>
