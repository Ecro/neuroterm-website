export function Features() {
  const features = [
    {
      title: 'Ask AI',
      description: 'Select any log, get instant root cause analysis.',
      icon: (
    ...
    {
      title: 'Local RAG',
      description: 'Reference your datasheets and manuals in answers.',
      icon: (
        <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    ...
    {
      title: 'Magic Input',
      description: 'Describe what you want, AI generates the command.',
      icon: (
        <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    ...
    {
      title: 'Smart Filter',
      description: 'Find patterns instantly with regex and highlights.',
      icon: (
        <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    ...
    },
    {
      ...
      description: 'Save port settings, reconnect with one click.',
      icon: (
        <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    ...
    {
      title: '100% Offline',
      description: 'Runs on Ollama. No data leaves your machine.',
      icon: (
        <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
