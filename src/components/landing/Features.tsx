export function Features() {
  const features = [
    {
      title: 'Magic Input',
      description: 'Describe it. Get the command.',
      icon: (
    ...
    {
      title: 'Serial + SSH + SFTP',
      description: 'Hardware and servers. One window.',
      icon: (
        <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    ...
    {
      title: 'Local RAG',
      description: 'Ask your datasheets. Get answers.',
      icon: (
        <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    ...
    },
    {
      ...
      description: 'Errors pop. Boot stages tracked.',
      icon: (
        <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    ...
    {
      title: '100% Offline',
      description: 'Your secrets stay on your machine.',
      icon: (
        <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
